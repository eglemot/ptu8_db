...
-- team_id INTEGER,
-- FOREIGN KEY (team_id) REFERENCES teams (id) --sasaja su lentele, greiciau join veikia
-- );
...
-- pwd VARCHAR(200),
-- FOREIGN KEY (coder_id) REFERENCES coders (id) - tik kad greiciau veiktu join'ai
-- );
